...
public class Nanami {
    ...
    public static void main(String args[]) {
        // Driver code opens up the application to the client
     ...
     * If the number is invalid (not part of the list of tasks or an empty string), the user is reprompted.
     * If the method cannot access the data file properly to make changes, the application terminates.
     *
     ...
     * If the method cannot access the data file properly to make changes, it is indicated to the user and
    ...
    public static void giveFarewell() {
        ...
        try {
            appender = new FileWriter(outfile, true);
            appender.write("xx"); // text marker for analysis purposes
        } catch (IOException e) {
    ...
    /**
     * Repopulates the new list of tasks with tasks from the previous session when the application is first opened.
     * The data file is rewritten at the end of this function to prevent duplicates and ensure a clean list in the file.
    ...
    /**
     * Searches for the task corresponding with the provided task number and removes it from the list and memory.
     * If the task number indicated is not in the list of tasks, the user is reprompted.
     * If the method cannot access the data file properly to make changes, the user is reprompted.
     *
